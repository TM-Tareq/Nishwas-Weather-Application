    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-brand-800 tracking-tight">Create account</h1>
          <p className="text-gray-500 mt-1 text-sm">Join <span className="font-semibold text-brand-600">Nishwas</span> — breathe better</p>
        </div>
